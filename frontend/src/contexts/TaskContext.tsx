...
interface TaskContextType {
  ...
  loading: boolean;
  error: string | null;
  fetchTasks: (filter?: string, sortBy?: string, isCompleted?: boolean, todoStateId?: number, assignedToId?: number, unassignedOnly?: boolean, projectId?: number) => Promise<void>;
...
export const TaskProvider = ({ children }: TaskProviderProps) => {
  ...
  const fetchTasks = async (filter?: string, sortBy?: string, isCompleted?: boolean, todoStateId?: number, assignedToId?: number, unassignedOnly?: boolean, projectId?: number) => {
    try {
      setLoading(true);
      setError(null);
      const data = await taskApi.getAll({ filter, sortBy, isCompleted, todoStateId, assignedToId, unassignedOnly, projectId });
      setTasks(data);
    } catch (err) {
